...
// font/style origins are needed. 'unsafe-inline' for scripts/styles is
// kept because Next.js injects hydration and Framer Motion injects
// inline styles; removing it requires nonce-based CSP middleware.
