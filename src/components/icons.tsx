...
export function GitHubIcon({ size = 18, className, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 .7a11.3 11.3 0 0 0-3.57 22.02c.56.1.77-.24.77-.54v-2.1c-3.14.68-3.8-1.34-3.8-1.34-.51-1.3-1.25-1.65-1.25-1.65-1.02-.7.08-.69.08-.69 1.13.08 1.73 1.16 1.73 1.16 1 1.72 2.63 1.22 3.27.93.1-.73.39-1.22.71-1.5-2.5-.28-5.13-1.25-5.13-5.57 0-1.23.44-2.24 1.16-3.03-.12-.28-.5-1.43.11-2.98 0 0 .94-.3 3.1 1.16a10.7 10.7 0 0 1 5.64 0c2.16-1.46 3.1-1.16 3.1-1.16.61 1.55.23 2.7.11 2.98.72.79 1.16 1.8 1.16 3.03 0 4.33-2.64 5.28-5.15 5.56.4.35.76 1.04.76 2.1v3.11c0 .3.2.65.78.54A11.3 11.3 0 0 0 12 .7Z" />
    </svg>
  );
}
...
export function NetworkIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
export function MenuIcon({ open = false, size = 20, className, ...props }: MenuIconProps) {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
export function MonitorIcon({ size = 16, className, ...props }: IconProps) {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
export function ArrowUpIcon({ size = 18, className, ...props }: IconProps) {
  return (
    <svg
      aria-hidden="true"
      width={size}
